    ...
    <div class="card">
      ...
      <div class="search-box">
        <span class="search-icon" aria-hidden="true">
          <svg class="inline-icon inline-icon--sm" viewBox="0 0 24 24">
            <path d="M15.5 14h-.79l-.28-.27a6.5 6.5 0 1 0-.71.71l.27.28v.79L20 20.5 21.5 19l-6-5zm-6 0a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9z" />
          </svg>
        </span>
        <input 
          v-model="searchQuery" 
